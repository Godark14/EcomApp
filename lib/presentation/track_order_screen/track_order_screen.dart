...
class TrackOrderScreenState extends State<TrackOrderScreen> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.v),
                  _buildOrderPreparation(context),
                  SizedBox(height: 4.v),
                  Padding(
                    padding: EdgeInsets.only(left: 32.h),
                    child: SizedBox(
  ...
  /// Section Widget
  Widget _buildOrderPreparation(BuildContext context) {
    return Row(
      children: [
        Container(
          height: 64.v,
  ...
  /// Section Widget
  Widget _buildOrderDelivery(BuildContext context) {
    return Row(
      children: [
        Container(
          height: 64.v,
  ...
  /// Section Widget
  Widget _buildOrderLocation(BuildContext context) {
    return SizedBox(
      height: 128.v,
      width: 327.h,
      child: GoogleMap(
  ...
  /// Section Widget
  Widget _buildOrderReceived(BuildContext context) {
    return Row(
      children: [
        Container(
          height: 64.v,
