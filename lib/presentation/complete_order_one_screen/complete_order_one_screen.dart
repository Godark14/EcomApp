import 'models/complete_order_one_model.dart';
...
import 'provider/complete_order_one_provider.dart';

class CompleteOrderOneScreen extends StatefulWidget {
  const CompleteOrderOneScreen({Key? key})
      : super(
          key: key,
        );

  @override
  CompleteOrderOneScreenState createState() => CompleteOrderOneScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CompleteOrderOneProvider(),
      child: CompleteOrderOneScreen(),
    );
  }
}

class CompleteOrderOneScreenState extends State<CompleteOrderOneScreen> {
  @override
  void initState() {
    super.initState();
  }
