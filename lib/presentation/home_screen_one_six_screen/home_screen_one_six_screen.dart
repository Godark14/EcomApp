import 'models/home_screen_one_six_model.dart';
...
import 'provider/home_screen_one_six_provider.dart';

class HomeScreenOneSixScreen extends StatefulWidget {
  const HomeScreenOneSixScreen({Key? key})
      : super(
          key: key,
        );

  @override
  HomeScreenOneSixScreenState createState() => HomeScreenOneSixScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => HomeScreenOneSixProvider(),
      child: HomeScreenOneSixScreen(),
    );
  }
}

class HomeScreenOneSixScreenState extends State<HomeScreenOneSixScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildHelloTonyWhatSeven(BuildContext context) {
    return Row(
      children: [
        Expanded(
          child: Selector<HomeScreenOneSixProvider, TextEditingController?>(
            selector: (
              context,
              provider,
            ) =>
