import 'models/complete_order_thirteen_model.dart';
import 'package:ecomapp/core/app_export.dart';
import 'package:ecomapp/widgets/custom_elevated_button.dart';
import 'package:flutter/material.dart';
import 'provider/complete_order_thirteen_provider.dart';

class CompleteOrderThirteenScreen extends StatefulWidget {
  const CompleteOrderThirteenScreen({Key? key})
      : super(
          key: key,
        );

  @override
  CompleteOrderThirteenScreenState createState() =>
      CompleteOrderThirteenScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CompleteOrderThirteenProvider(),
      child: CompleteOrderThirteenScreen(),
    );
  }
}

class CompleteOrderThirteenScreenState
    extends State<CompleteOrderThirteenScreen> {
  @override
  void initState() {
    super.initState();
  }
