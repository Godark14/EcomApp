import 'dart:async';
import 'models/complete_order_thirtyseven_model.dart';
...
import 'provider/complete_order_thirtyseven_provider.dart';

class CompleteOrderThirtysevenScreen extends StatefulWidget {
  const CompleteOrderThirtysevenScreen({Key? key})
      : super(
          key: key,
        );

  @override
  CompleteOrderThirtysevenScreenState createState() =>
      CompleteOrderThirtysevenScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CompleteOrderThirtysevenProvider(),
      child: CompleteOrderThirtysevenScreen(),
    );
  }
}

class CompleteOrderThirtysevenScreenState
    extends State<CompleteOrderThirtysevenScreen> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.v),
                  _buildOrderReceivedSection(context),
      ...
      children: [
        Container(
          ...
          child: CustomIconButton(
            ...
            decoration: IconButtonStyleHelper.fillGreenTL20,
            alignment: Alignment.center,
            child: CustomImageView(
              imagePath: ImageConstant.imgTopcoatCheckmark,
            ),
        ...
        Container(
          ...
          child: AnimatedSmoothIndicator(
            ...
            effect: ScrollingDotsEffect(
              spacing: 8,
              activeDotColor: appTheme.orange100,
